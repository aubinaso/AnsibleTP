...
createNodes() {
	...
	for i in $(seq $min $max);do
        ...
        docker exec -ti $mainuser-debian-$i /bin/sh -c "sed -i 's/#PasswordAuthentication/PasswordAuthentication/' /etc/ssh/sshd_config"
        docker exec -ti $mainuser-debian-$i /bin/sh -c "sed -i 's/#PermitEmptyPasswords no/PermitEmptyPasswords yes/' /etc/ssh/sshd_config"
